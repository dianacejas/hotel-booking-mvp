...
type Point = { icon: FunctionComponent; text: string };
type NearPlace = { icon: FunctionComponent; title: string; text: string; distance: string };
...
/**
 * Ubicación, formas de llegar y qué hacer cerca. El iframe de Google Maps
 * se incrusta sin clave de API usando el render de "output=embed".
 */
    ...
    <section className="landing-section">
      ...
      <div className="loc-grid">
        <div className="card loc-map-card">
          <iframe
            src={mapsEmbed}
            title={`Mapa de ${site.name} en Google Maps`}
            className="loc-map"
            loading="lazy"
